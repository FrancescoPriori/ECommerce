...
namespace Priori.francesco._5h.ECommerce.Controllers
{
    public class UtentiController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ReleaseDate,Genre,Username,Password")] Utenti utenti)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ReleaseDate,Genre,Username,Password")] Utenti utenti)
        {
            if (id != utenti.Id)
            {
                return NotFound();
